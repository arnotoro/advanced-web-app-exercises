async function getDogs() {
    // dog api
    const urlDogImg = "https://dog.ceo/api/breed/terrier/westhighland/images/random"
    const dogImg = await fetch(urlDogImg)
    const imgJSON = await dogImg.json()

    // wikipedia summary
    const urlSummary = "https://en.wikipedia.org/api/rest_v1/page/summary/West_Highland_White_Terrier"
